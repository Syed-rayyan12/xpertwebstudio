    ...
    <div className="w-full relative flex flex-wrap min-h-screen mt-40 max-w-7xl mx-auto lg:rounded-3xl overflow-hidden">
      ...
      <div className="absolute top-0 right-0 flex h-full z-20 py-4 px-6 lg:py-6 lg:px-10">
        <div className="sticky bottom-6 left-0 self-end">
          ...
          >
            {/* Button Background */}
            <div className="absolute top-0 left-0 w-full h-full z-0 rounded-full bg-white dark:bg-gray-800"></div>
      ...
      <div className="px-2 lg:px-3 xl:px-4 absolute -left-3 top-0 z-20 flex flex-col items-start pb-8 w-auto lg:left-20 xl:left-40">
        ...
        <div className="w-20 bg-[#1A1B1E] h-40 absolute top-0 left-5 z-10 transform -translate-x-full lg:w-44 dark:bg-gray-800"></div>
        
        {/* Top Right Corner Cutout */}
        <svg className="w-10 h-10 text-white z-30  fill-current absolute top-40 left-3 -mt-px ml-px transform -translate-x-full xl:left-4 dark:text-gray-800" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
          <path d="M98.1 0h1.9v51.9h-1.9c0-27.6-22.4-50-50-50V0h50z" className='fill-[#1A1B1E]'></path>
        </svg>
        
        {/* Top Left Corner Cutout */}
        <svg className="w-10 h-10 text-white z-30 fill-current absolute -mt-px -ml-px top-40 -left-17 xl:-left-36 dark:text-gray-800" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
          <path d="M51.9 0v1.9c-27.6 0-50 22.4-50 50H0V0h51.9z" className='fill-[#1A1B1E]'></path>
        </svg>
        ...
        <div className="w-auto relative">
          {/* Corner Cutout SVG */}
          <svg className="w-9 h-9 lg:w-10 lg:h-10 text-white z-30 fill-current absolute -mt-px top-0.5 right-px transform -translate-y-10 translate-x-full dark:text-gray-800" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M51.9 0v1.9c-27.6 0-50 22.4-50 50H0V0h51.9z"></path>
          </svg>

          {/* Heading */}
          <div className="w-auto relative rounded-br-2xl lg:rounded-br-3xl overflow-hidden">
            <div className="relative">
              <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl 2xl:text-8xl leading-none tracking-tight text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 pt-16 pb-3">
        ...
        {/* Buttons Container */}
        <div className="relative bg-white dark:bg-gray-800 rounded-b-xl lg:rounded-b-2xl pr-3 pl-3 pb-3 mt-2.5 pt-1 inline-flex lg:pt-3 lg:mt-0 lg:pr-8 lg:pl-5 lg:pb-5">
          
          {/* Bottom Right Corner Cutout */}
          <svg className="w-10 h-10 text-white fill-current absolute -mt-px -ml-px right-px top-1 lg:top-3 xl:top-3 transform translate-x-full dark:text-gray-800" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M51.9 0v1.9c-27.6 0-50 22.4-50 50H0V0h51.9z"></path>
          </svg>
