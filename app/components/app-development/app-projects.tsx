        ...
        <section className='px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16'>
            <div className='max-w-[1280px] mx-auto'>
                <div className='mb-8 sm:mb-10 md:mb-12'>
                    ...
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-white text-center'><span className='text-[#FF5900]'>Mobile </span>App Development Packages Built for Success</h2>
                    <p className='text-white text-sm sm:text-base mt-3 sm:mt-4 text-center'>Boost your brand, engage customers, and grow with XpertWebStudio. </p>
                </div>
