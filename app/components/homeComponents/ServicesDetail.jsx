...
const ServicesDetail = () => {
    ...
    // ...existing code...
    return (
        <section className=' xl:mx-6  lg:mx-6  max-sm:mx-4 max-sm:mx-4 md:mx-4 sm:mx-4 bg-[#1A1B1E] rounded-xl'>
            <div className=" w-full xl:px-16  lg:px-12  max-sm:px-4 max-sm:px-4 md:px-10 sm:px-6   mx-auto mt-10  pb-12 text-white">
