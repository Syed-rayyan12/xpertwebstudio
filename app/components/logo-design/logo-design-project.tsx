...
const WebDesignProjects = () => {
    const projects = [
        {
            id: 1,
            image: '/images/logo-design-1.png',
            company: 'TechVision Inc.',
            heading: 'Digital Marketing Design'
        },
        {
            id: 2,
            image: '/images/logo-design-2.png',
            company: 'EcoMarket',
            heading: 'Digital Marketing Design'
        },
        {
            id: 3,
            image: '/images/logo-design-3.png',
            company: 'HealthHub',
            heading: 'Digital Marketing Design'
        },
        {
            id: 4,
            image: '/images/logo-design-4.png',
            company: 'FinanceFlow',
            heading: 'Digital Marketing Design'
        },
        {
            id: 5,
            image: '/images/logo-design-5.png',
            company: 'EduLearn',
            heading: 'Digital Marketing Design'
        },
        {
