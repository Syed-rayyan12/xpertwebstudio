        ...
        <>
            <div className='mx-auto max-w-[1280px] pt-30 sm:pt-24 md:pt-32 lg:pt-40 px-4 sm:px-6 md:px-8'>
                <div className='relative'>
                    <img src="/images/dek.png" alt="Service Banner One" className='w-full h-full max-sm:h-[400px] max-sm:object-cover rounded-lg sm:rounded-xl right-2 sm:right-4 md:right-6 bottom-2 sm:bottom-4 md:bottom-6' />
